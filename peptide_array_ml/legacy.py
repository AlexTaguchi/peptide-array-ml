...
#=== LEGACY FEED-FORWARD NEURAL NETWORK 2020 ===#
...
#=== LEGACY FEED-FORWARD NEURAL NETWORK 2022 ===#
class NeuralNetwork2022():
    """Neural Network for Peptide Binding Prediction - Chowdhury & Woodbury et al (2022)
...
if __name__ == '__main__':
    ...
    neural_network = NeuralNetwork2022(**param_dictionary)
    pool = Pool()
